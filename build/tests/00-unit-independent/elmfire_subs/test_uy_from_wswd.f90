...
REAL :: WS_VAL, WD_VAL, EXPECTED_UY
INTEGER :: NFAIL = 0
...
! =============================================================================
SUBROUTINE CHECK(WS_VAL, WD_VAL, EXPECTED_UY)
! =============================================================================
REAL, INTENT(IN) :: WS_VAL, WD_VAL, EXPECTED_UY     ! Inputs
REAL :: ACTUAL_UY                                   ! Locals
ACTUAL_UY = UY_FROM_WSWD(WS_VAL, WD_VAL)

IF (ABS(ACTUAL_UY - EXPECTED_UY) > TOL) THEN
    PRINT *, 'FAIL: WS_VAL=', WS_VAL, ' WD_VAL=', WD_VAL, ' UY=', ACTUAL_UY, &
            ' Expected UY=', EXPECTED_UY
    NFAIL = NFAIL + 1
END IF
! =============================================================================
