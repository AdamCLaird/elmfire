...
!! Unit test for function UX_FROM_WSWD in elmfire_subs.f90
!! Updated: 07-25-2025

! *****************************************************************************
PROGRAM TEST_UX_FROM_WSWD
! *****************************************************************************
...
CALL CHECK(10.0, 0.0, 0.0)          ! North
CALL CHECK(10.0, 90.0, -10.0)       ! East
CALL CHECK(10.0, 180.0, 0.0)        ! South
CALL CHECK(10.0, 270.0, 10.0)       ! West
